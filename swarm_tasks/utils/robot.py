...
DEFAULT_NEIGHBOURHOOD_VAL = 10  # neighbourhood radius
DEFAULT_SIZE = 0.6  # Radius of chassis
MAX_SPEED = 1.8
MAX_ANGULAR = 0.3
DEFAULT_STATE = 0
SEARCH_STATE = 2
...
class Bot:
    ...
    def move(self, direction, speed, step_size=0.05):
        ...
        turn_angle = np.arctan2(
            np.sin(direction - self.theta),
            np.cos(direction - self.theta) * np.cos(bank_angle),
        )
